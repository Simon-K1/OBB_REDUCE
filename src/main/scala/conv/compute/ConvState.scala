...
object CONV_STATE extends Area {
    ...
    def COL_NUM_IN = 20 downto 11

    def CHANNEL_IN = 31 downto 21
    ...
    val Reg2 = ("CONV_TYPE", CONV_TYPE.length, "FIRST_LAYER", FIRST_LAYER.length, "EN_ARRANGE", EN_ARRANGE.length)

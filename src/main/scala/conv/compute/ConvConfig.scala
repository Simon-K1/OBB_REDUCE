...
case class ConvConfig(DATA_WIDTH: Int, COMPUTE_CHANNEL_IN_NUM: Int, COMPUTE_CHANNEL_OUT_NUM: Int, CHANNEL_WIDTH: Int, WEIGHT_DEPTH: Int, QUAN_DEPTH: Int, FEATURE: Int, FEATURE_RAM_DEPTH: Int, ZERO_NUM: Int) {
    ...
    val WEIGHT_S_DATA_WIDTH = DATA_WIDTH * COMPUTE_CHANNEL_IN_NUM * PICTURE_NUM         // 64
    val WEIGHT_S_DATA_DEPTH = WEIGHT_DEPTH
    val WEIGHT_M_DATA_WIDTH = DATA_WIDTH * COMPUTE_CHANNEL_IN_NUM * COMPUTE_CHANNEL_OUT_NUM      // 8 * 8 * 8
    val WEIGHT_M_DATA_DEPTH = WEIGHT_S_DATA_WIDTH * WEIGHT_S_DATA_DEPTH / WEIGHT_M_DATA_WIDTH    // 8192 * 64 / 8
